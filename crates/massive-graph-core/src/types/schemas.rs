...
pub enum ParamType {
    /// Array index parameter [*] -> varint encoded index
    ArrayIndex = 0x01,
    /// Map key parameter {} -> length-prefixed string
    MapKey = 0x02,
    /// Dynamic segment parameter {{userId}} -> captured string segment
    DynamicSegment = 0x03,
}
...
#[allow(dead_code)] // POC: Function will be used in future implementation
